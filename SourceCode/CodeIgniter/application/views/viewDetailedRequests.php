                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                 <?php echo form_open('RecommendationController/addRecommendation'); ?>
                                  <div class="row">
                                      <div class="col-md-6">
                                ...
                                <div class="row">
                                      <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type='text' class="form-control" value="<?php echo $request[0]['requestedBy'] ?>" id="recevId" name="recevId" disabled/>     
                                            </div>
                                        </div>
