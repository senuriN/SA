...
function directToPage(nid)
{
                 ...
                 $.ajax({
                        ...
                        success: function(response) {
                            window.location.href = "<?php echo base_url("/index.php/RequestController/sentRequests"); ?>";
                        },
...
<script>
    function disable() {
    document.getElementById("txtReceiver").disabled=true;
    document.getElementById("txtReceiver").value = 1;
}
    
    
     function enable() {
    document.getElementById("txtReceiver").disabled=false;
