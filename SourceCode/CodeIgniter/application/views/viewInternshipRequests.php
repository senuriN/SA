	...
	<div class="sidebar" data-color="" data-image="<?php echo base_url("assets/img/taro/sidebar.png") ?>">
		...
		<div class="sidebar-wrapper">
          ...
          <ul class="nav" id="sideBarMenu">
              ...
              <li class="active"> <a href="<?php echo base_url("/index.php/RequestController/viewInternshipRequests"); ?>">
                            <i class="fa fa-envelope-o small"></i> <span> <small>Internship Letter  Requests </small></span>
                        </a>
                    </li>
                    <li > <a href="<?php echo base_url("/index.php/RequestController/viewRecomendationRequests"); ?>">
                            <i class="fa fa-file-text-o small"></i> <span> <small> Recommendation Requests </small> </span>
                        </a>
                    </li>
                    <li > <a href="<?php echo base_url("/index.php/RequestController/viewRequests"); ?>">
                            <i class="fa fa-inbox small"></i> <span> <small> Internship Requests </small> </span>
                        </a>
                    </li>
                </ul>
        ...
        <div class="col-lg-3">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                  <li class="active"><a href="#"><i class="fa fa-envelope-o"></i> Internship Letter Requests  </a> </li>
                ...
                <li><a href="<?php echo base_url("index.php/RequestController/viewRequests"); ?>"><i class="fa fa-inbox"></i> Internship Requests </a></li>
              </ul>
            </div>
        ...
        <div class="col-lg-8" style="background-color:#eaf2f8">
          <div class="box box-primary" style="background-color:#d9edf7">
            <div class="box-header with-border" style="background-color:#5dade2">
                <h4 class="typo-line"> Internship Letter Requests  </h4>
