		...
		<div class="sidebar-wrapper">
			<div class="main-header">
             ...
             <ul class="nav" id="sideBarMenu">
                    ...
                    <li class="active"> <a href="<?php echo base_url("/index.php/RequestController/viewRecomendationRequests"); ?>">
        ...
        <div class="col-lg-3">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li  class="active"><a href="#"><i class="fa fa-file-text-o"></i> Recommendation Requests </a></li>
        ...
        <div class="col-lg-8" style="background-color:#eaf2f8">
          <div class="box box-primary" style="background-color:#d9edf7">
            <div class="box-header with-border" style="background-color:#5dade2">
                <h4 class="typo-line"> Recommendation Requests </h4>
