                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                 <?php echo form_open("RecommendationController/addRecommendation/". $request[0]['rid']); ?>
                                  <div class="row">
                                      <div class="col-md-6">
                                ...
                                <div class="row">
                                      <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type='text' class="form-control" id="recevId" name='recevId' value="<?php echo $request[0]['requestedBy'] ?>"  disabled/>     
                                            </div>
                                        </div>
                                      
                                      <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Student SLIIT ID</label>
                                                <input type='text' class="form-control" id="sid" name="sid" value="<?php echo $receiver[0]['uid'] ?>" disabled/>     
                                            </div>
                                        </div>
                                    <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Message </label>
                                                <textarea rows="5" class="form-control" id="txtMsg"  name="txtMsg" disabled> 
                                      ...
                                      <div class="row" id="recommendation">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control" placeholder="Here can be the recommendation for the student"  name='txtRecomnd'> </textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <button type="submit" class="btn btn-info btn-fill pull-right">Add Recommendation</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
